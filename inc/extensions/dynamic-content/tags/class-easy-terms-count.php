...
class Easy_Terms_Count extends Tag {

    public function get_name() {
        return 'easy-count-terms-dynamic';
    }

    public function get_title() {
        return __( 'Terms Count', 'easy-elements-pro' );
    }
    ...
    public function render() {
        ...
        // Get term count instead of slug
        ...
        echo wp_kses_post( $before . $term_count . $after );
    }
