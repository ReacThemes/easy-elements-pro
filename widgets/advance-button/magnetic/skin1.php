...
<a href="<?php echo esc_url($link); ?>" <?php echo wp_kses_post($is_external); ?> class="eel-advance-button eel-advance-button-magnetic button button--stroke" data-duration ="<?php echo esc_attr($settings['magnetic_btn_ani_duration'] )?>">
