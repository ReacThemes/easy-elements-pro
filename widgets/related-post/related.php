...
class Easyel_Related_Post_Widget extends \Elementor\Widget_Base { 

    public function get_style_depends() {
        $handle = 'eel-related-post';
        $css_path = plugin_dir_path( __FILE__ ) . 'css/related.css';
        ...
        if ( ! wp_style_is( $handle, 'registered' ) && file_exists( $css_path ) ) {
            wp_register_style( $handle, plugins_url( 'css/related.css', __FILE__ ), [], defined( 'WP_DEBUG' ) && WP_DEBUG ? filemtime( $css_path ) : '1.0.0' );
        }
    ...
    public function get_name() {
        return 'eel-related-post';
    }

    public function get_title() {
        return esc_html__( 'Easy Related Post', 'easy-elements' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            '_section_grid',
            [
                'label' => esc_html__( 'Related Posts Settings', 'easy-elements' ),
        ...
        $this->add_control(
            'title_trim',
            [
                'label' => esc_html__( 'Title Trim', 'easy-elements' ),
        ...
        $this->add_control(
            'excerpt_trim',
            [
                'label' => esc_html__( 'Excerpt Trim', 'easy-elements' ),
                'type' => Controls_Manager::NUMBER,
                'default' => 20,
                'min' => 5,
                'max' => 200,
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .eel-post-grid-wrap .grid-item img, {{WRAPPER}} .eel--blog-img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render() {
        ...
        // Additional exclusions if specified
        if ( ! empty( $settings['exclude_posts'] ) ) {
            $existing_exclusions = isset($args['post__not_in']) ? $args['post__not_in'] : array();
            $args['post__not_in'] = array_merge($existing_exclusions, $settings['exclude_posts']);
        }
